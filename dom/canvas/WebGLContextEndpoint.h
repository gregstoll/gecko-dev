...
#define FUNC_SCOPE_NAME(_name) [FuncScopeId::_name] = #_name
    static constexpr const char* const FuncScopeNames[] = {
        ...
        FUNC_SCOPE_NAME(drawingBufferHeight),
        FUNC_SCOPE_NAME(drawingBufferSize),
        FUNC_SCOPE_NAME(drawingBufferWidth),
        FUNC_SCOPE_NAME(getSurfaceSnapshot),
...
#undef FUNC_SCOPE_NAME
 ...
 protected:
  explicit WebGLContextEndpoint(WebGLVersion aVersion) : mVersion(aVersion) {}
